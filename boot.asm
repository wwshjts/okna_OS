[BITS 16]
;Управление передается по физическому адресу 0x006С00
...
hello:
	...
	mov al, [data + bx]	; подготавливаем текущий симовол для печати:w
...
;Генерируем строчку "Hello, world"
	db 0x48, 0x65, 0x6C, 0x6C, 0x6F, 0x2C, 0x20, 0x77, 0x6F, 0x72, 0x6C, 0x64, 0
